...
pages within a shared responsive header and footer shell. The Projects page presents selected public
repositories with descriptive technology labels and safe external links.
